...
const FileItem = ({
  ...
  <TouchableOpacity className="flex-row mb-4 rounded-2xl border border-slate-700/50">
    <View className="flex-row items-center flex-1">
      {/* Thumbnail Placeholder */}
      <View className="w-14 h-14 rounded-lg items-center justify-center overflow-hidden">
        {type === "pdf" ? (
  ...
  return (
    <View className="bg-white flex-1">
      ...
      <View className="pb-10">
        <FileItem title="ScanOn 19032026025655" date="19/03/2026" type="img" />
        <FileItem
          title="MOAZ CV"
          date="19/03/2026"
          size="418.9 KB"
